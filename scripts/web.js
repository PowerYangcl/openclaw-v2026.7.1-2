#!/usr/bin/env node
// Routes Web UI package commands through the repo's Node/pnpm wrappers.
...
function usage() {
  ...
  process.stderr.write("Usage: node scripts/web.js <install|dev|build|test> [...args]\n");
}
